...
def render_interactive_target_planner(
    ...
    # --------------------------------------------------------
    # RESET SLIDER KHI ĐỔI XƯỞNG / THÁNG / DỮ LIỆU
    # --------------------------------------------------------
    ...
    with card_left:
        # Không dùng border=True vì sẽ tạo viền vuông mặc định
...
""",
    ...
    # --------------------------------------------------------
    # KẾT QUẢ ĐẶT NGOÀI CARD
    # CARD PHÍA TRÊN KHÔNG BỊ THAY ĐỔI CHIỀU CAO
    # --------------------------------------------------------
